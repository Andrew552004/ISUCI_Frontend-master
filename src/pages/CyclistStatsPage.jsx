...
function CyclistStatsPage() {
    ...
    return (
        <AppBase>
            <div className="text-4xl font-bold px-6 py-4">Estadísticas de Ciclistas</div>

            <div className="flex">
                <div className="w-full">
                    <div className="text-2xl font-bold px-6 py-4">Filtrar por periodo</div>
                    <div className="flex pl-4 items-end">
                        ...
                        <button
                            ...
                            className="m-2 max-h-14 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center"
                        >
