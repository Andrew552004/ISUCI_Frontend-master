...
function RegisterCustomer() {
  ...
  return (
    <AppBase>
      <div className="pt-6">
        <div
          className="text-4xl font-bold px-6 py-4"
          style={{ color: "black" }}
        >
          Registrar Usuario
        </div>
        ...
        <div
          className="p-10 space-y-6 text-gray-700 sm:text-lg sm:leading-7 w-11/12 mx-auto"
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col">
                <label
                  className="leading-loose font-semibold text-lg"
                  style={{ color: "black" }}
                >
                  Tipo de Perfil
                </label>
